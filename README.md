...
<head>
  ...
  <title>Abdullha Hill Oneir | Android Developer Portfolio</title>

  <!-- (Optional) Favicon & Social Preview -->
  <link rel="icon" type="image/png" href="favicon.png">
  <meta property="og:title" content="Abdullha Hill Oneir | Android Developer Portfolio">
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .toggle-btn:hover { background: #e3e3e3; }
